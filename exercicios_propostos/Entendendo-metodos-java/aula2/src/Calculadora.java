public class Calculadora {
    ...
    public Calculadora(){}
    public Calculadora(double largura){
        double areaQuadrado = largura * largura;
        System.out.println("Área do Quadrado: " + areaQuadrado);
    }
    public Calculadora(double largura,double comprimento){
        double areaRetangulo = largura*comprimento;
        System.out.println("Área do Retangulo: " + areaRetangulo);
    }
    public Calculadora(double largura,double comprimento, double altura){
